...
export const ReportsDashboard: React.FC<ReportsDashboardProps> = ({
  ...
  return (
    <div id="reports-dashboard-root" className="space-y-6">
      ...
      {/* KPI Cards Grid */}
      {loadingReports && (
        <div className="bg-white rounded-3xl p-4 border border-[#e5e5d1] shadow-sm text-center text-xs text-[#737366]">
          <span className="inline-flex items-center space-x-2">
            <span className="w-3 h-3 border-2 border-[#5A5A40] border-t-transparent rounded-full animate-spin" />
